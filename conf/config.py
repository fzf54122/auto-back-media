...
class Settings(BaseSettings):
    ...
    VERSION: str = "1.0.0"
    APP_TITLE: str = "auto-back-media"
    PROJECT_NAME: str = "auto-back-media"
    APP_DESCRIPTION: str = "自动化媒体发布后端项目"

    CORS_ORIGINS: str = os.getenv("CORS_ORIGINS", "http://localhost:3000,http://localhost:8080")
    TABLE_PREFIX: str = "auto_back_media_"
    @property
    ...
    # 数据库配置
    DB_ENGINE: str = "postgresql"  # 默认使用PostgreSQL
    DB_HOST: str = "localhost"
    DB_PORT: int | None = Field(default=5432, validate_default=True)

    LOCATION: str = "./application/migration"

    DB_USER: str = os.getenv("DB_USER", "postgres")
    DB_PASSWORD: str = os.getenv("DB_PASSWORD", "")
    DB_NAME: str = "auto_back_media_db"
    ...
    SWAGGER_UI_USERNAME: str = os.getenv("SWAGGER_UI_USERNAME", "admin")
    SWAGGER_UI_PASSWORD: str = "fzf991013"
